  ...
  try {
    ...
    const result = await preference.create({
      body: {
        ...
        back_urls: {
          success: 'http://54.190.126.4/?status=approved',
          failure: 'http://54.190.126.4/?status=rejected',
          pending: 'http://54.190.126.4/?status=pending'
        },
  ...
  try {
    ...
    const result = await preference.create({
      body: {
        ...
        back_urls: { 
          success: 'http://54.190.126.4', 
          failure: 'http://54.190.126.4', 
          pending: 'http://54.190.126.4' 
        }
      }
    });
